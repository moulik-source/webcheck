...
__license__ = """
Webcheck is a free script which read the Robots.txt file of a web server and
...
Author: Moulik
    Moulik | www.techyrick.com
    Web: www.techyrick.com
    webcheck project site: https://github.com/moulik-sourec/webcheck
...
\$$$$$\$$$$  |\$$$$$$$\ $$$$$$$  |\$$$$$$$\ $$ |  $$ |\$$$$$$$\ \$$$$$$$\ $$ | \$$\ 
 \_____\____/  \_______|\_______/  \_______|\__|  \__| \_______| \_______|\__|  \__|
                      ...
                      # Coded By MOULIK - www.techyrick.com
...
def conn_check(url, only200):
    ...
    try:
        ...
        print("\n" + bcolors.FAIL + "e.g: python3 webcheck.py -u www.behindthefirewalls.com -o -sb" + bcolors.ENDC + "\n")
        salida = 0
...
def date(url):
    print("Starting webcheck v0.81 (https://github.com/moulik-source/webcheck) at " + time.strftime("%x") + " " + time.strftime("%X"))
    print("webcheck scan report for " + url)
